        ...
        .get_or_init(|| {
            let mut tools = vec![
                ...
                tool(
                    ...
                    vec![
                        ...
                        ToolParameter {
                            ...
                            required: false,
                            description:
                                "Optional postcode override applied before downstream processing.",
                        },
                        ToolParameter {
                            ...
                            required: false,
                            description:
                                "Optional full address override applied before downstream processing.",
                        },
                        ToolParameter {
                            name: "--skip-images",
                            param_type: "bool",
                ...
                tool(
                    ...
                    "let ops patch <id>",
                    "ops",
                    "Override stored listing fields, validate inputs, and recompute scores without refetching.",
                    vec![
                        ToolParameter {
                            name: "id",
                            param_type: "string",
                        ...
                        ToolParameter {
                            ...
                            param_type: "string",
                            required: false,
                            description: "Override listing region label.",
                        },
                        ToolParameter {
                            name: "--epc-rating",
                            param_type: "string",
                        ...
                        ToolParameter {
                            name: "--gigabit-availability",
                            param_type: "number",
                            required: false,
                            description: "Override gigabit availability percentage (0-100).",
                        },
                        ToolParameter {
                            name: "--crime-rate-per-1k",
                            param_type: "number",
                            required: false,
                            description: "Override area crime rate per 1,000 residents.",
                        },
                        ToolParameter {
                            name: "--crime-count-12m",
                            param_type: "number",
                            required: false,
                            description: "Override area total crime count over last 12 months.",
                        },
                        ToolParameter {
                            name: "--crime-violent-12m",
                            param_type: "number",
                            required: false,
                            description: "Override area violent crime count over last 12 months.",
                        },
                        ToolParameter {
                            name: "--crime-burglary-12m",
                            param_type: "number",
                            required: false,
                            description: "Override area burglary count over last 12 months.",
                        },
                        ToolParameter {
                            name: "--crime-robbery-12m",
                            param_type: "number",
                            required: false,
                            description: "Override area robbery count over last 12 months.",
                        },
                        ToolParameter {
                            name: "--imd-decile",
                            param_type: "number",
                            required: false,
                            description: "Override IMD decile (1-10).",
                        },
                        ToolParameter {
                            name: "--imd-rank",
                            param_type: "number",
                            required: false,
                            description: "Override IMD rank (>0).",
                        },
                        ToolParameter {
                            name: "--imd-score",
                            param_type: "number",
                            required: false,
                            description: "Override IMD score (>=0).",
                        },
                        ToolParameter {
                            name: "--lsoa-code",
                            param_type: "string",
                            required: false,
                            description: "Override LSOA code.",
                        },
                        ToolParameter {
                            name: "--lsoa-name",
                            param_type: "string",
                            required: false,
                            description: "Override LSOA name.",
                        },
                        ToolParameter {
                            name: "--msoa-code",
                            param_type: "string",
                            required: false,
                            description: "Override MSOA code.",
                        },
                        ToolParameter {
                            name: "--msoa-name",
                            param_type: "string",
                            required: false,
                            description: "Override MSOA name.",
                        },
                        ToolParameter {
                            name: "--income-bhc",
                            param_type: "number",
                            required: false,
                            description: "Override area income (before housing costs).",
                        },
                        ToolParameter {
                            name: "--income-ahc",
                            param_type: "number",
                            required: false,
                            description: "Override area income (after housing costs).",
                        },
                        ToolParameter {
                            name: "--social-housing-pct",
                            param_type: "number",
                            required: false,
                            description: "Override area social housing percentage (0-100).",
                        },
                        ToolParameter {
                            name: "--population",
                            param_type: "number",
                            required: false,
                            description: "Override area population (>=0).",
                        },
                        ToolParameter {
                            name: "--flood-risk-level",
                            param_type: "string",
                            required: false,
                            description: "Override flood risk level label.",
                        },
                        ToolParameter {
                            name: "--flood-risk-source",
                            param_type: "string",
                            required: false,
                            description: "Override flood risk source label.",
                        },
                        ToolParameter {
                            name: "--crime-band",
                            param_type: "string",
                            required: false,
                            description: "Override crime band (excellent|good|mixed|concerning).",
                        },
                        ToolParameter {
                            name: "--crime-trend",
                            param_type: "string",
                            required: false,
                            description: "Override crime trend (improving|stable|worsening).",
                        },
                        ToolParameter {
                            name: "--crime-updated-at",
                            param_type: "string",
                            required: false,
                            description: "Override crime metrics date (YYYY-MM-DD).",
                        },
                        ToolParameter {
                            name: "--patch-json",
                            param_type: "string",
                            required: false,
                            description: "JSON object patch payload with nested area support; returns structured validation errors in error.details.",
                        },
                        ToolParameter {
                            name: "--skip-re-enrich",
                            param_type: "bool",
                ...
                tool(
                    ...
                    vec![
                        ...
                        ToolParameter {
                            ...
                            param_type: "number",
                            required: false,
                            description: "Max listings per location; discover paginates up to this limit.",
                        },
                    ],
                    vec![
                        "ids",
