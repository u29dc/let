        ...
        .get_or_init(|| {
            let mut tools = vec![
                ...
                tool(
                    ...
                    "let health",
                    "infra",
                    "Run readiness checks for config, intelligence DB, source DBs, credentials, and writable paths.",
                    vec![],
                ...
                tool(
                    ...
                    "let search discover",
                    "search",
                    "Discover Rightmove listing ids from configured or ad-hoc locations.",
                    vec![
...
const SEARCH_DISCOVER_INPUT: &str = r#"{"type":"object","properties":{"region":{"type":"string"},"location":{"type":"string"},"propertyTypes":{"type":"string"},"mustHave":{"type":"string"},"dontShow":{"type":"string"},"locationName":{"type":"string"},"limit":{"type":"integer"}}}"#;
...
const SEARCH_DISCOVER_OUTPUT: &str = r#"{"type":"object","required":["regions","listings"],"properties":{"regions":{"type":"array"},"listings":{"type":"array"}}}"#;
